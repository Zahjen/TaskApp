<?php
        ...
        class GroupManager {
                 ...
                 * 
                 * @param group Groupe que l'on souhaite insérer
                 */ 
                 ...
                 * 
                 * @param group Le groupe que l'on souhaite mettre à jour
                 */ 
                 ...
                 * 
                 * @param group Le groupe que l'on souhaite supprimer
                 */
                 ...
                 * 
                 * @param group Le groupe pour lequel on souhaite vérifier l'existence.
                 */
                public function exists(Group $group) {
                        $groups = $this->get_all("ASC");    

                        $id = $group->get_id();
                        $label = strtoupper($group->get_label());
