<?php
        ...
        class ListeManager {
                 ...
                 * 
                 * @param list Liste que l'on souhaite insérer
                 */ 
                 ...
                 * 
                 * @param list La liste que l'on souhaite mettre à jour
                 */ 
                 ...
                 * 
                 * @param list Le liste que l'on souhaite supprimer
                 */
                 ...
                 * 
                 * @param id L'id du liste que l'on souhaite trouver
                 */ 
                 ...
                 * 
                 * @param task La liste pour laquelle on vérifie l'existence
                 */
                public function exists(Liste $list) {
                        $id = $list->get_id();
                        $label = strtoupper($list->get_label());
