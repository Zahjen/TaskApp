<?php
    ...
    class TaskManager {
         ...
         * 
         * @param \Task $task Tache que l'on souhaite insérer
         */
         ...
         * 
         * @param \Task $task La tache que l'on souhaite mettre à jour
         */
         ...
         * 
         * @param \Task $task Le tache que l'on souhaite supprimer
         */
         ...
         * 
         * @param int $id L'id du tache que l'on souhaite trouver
         * @return \Task
         */
         ...
         * 
         * @param string $order L'ordre dans lequel on souhaite trier nos taches. Par défaut, on les ordonne du plus petit au plus grand.
         * @return array
         */
         ...
         * 
         * @param int $id_list L'id de la liste à laquelle appartient un même ensemble de taches
         * @param string $order L'ordre dans lequel on souhaite trier nos taches. Par défaut, on les ordonne du plus petit au plus grand.
         * @return array
         */
        ...
        public function exists(Task $task) {
            ...
            // On récupère toutes les taches dans la base de données ordonnés dans l'ordre croissant
            $tasks = $this->get_all_by_id_list($id_list, "ASC");

            // On recherche d'abord si l'id de la tache existe déjà dans la base de données
